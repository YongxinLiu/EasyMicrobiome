...
option_list <- list(
  ...
  make_option(c("-i", "--otutable"), type="character", default="gg/otutab.txt",
              help="otu table to plot [default %default]"),
  make_option(c("-c", "--mapcolumn"), type="character", default="Group",
              help="column of mapping file to plot [default %default]"),
  make_option(c("-m", "--mappingfile"), type="character", default="metadata.txt",
              help="mapping file to plot [default %default]"),
  make_option(c("-L", "--location"), type="character", default="C:/amplicon/02Software/script/BugBase",
              help="Location to program include scripts and database [default %default]"),  
